...
# 610 "C:/mingw64/x86_64-w64-mingw32/include/stdio.h" 3
  ...
  static inline __attribute__((__cdecl__)) int fseeko(FILE *_File, _off_t _Offset, int _Origin) {
    return fseek(_File, _Offset, _Origin);
  }
  static inline __attribute__((__cdecl__)) int fseeko64(FILE *_File, _off64_t _Offset, int _Origin) {
    return _fseeki64(_File, _Offset, _Origin);
  }
  static inline __attribute__((__cdecl__)) _off_t ftello(FILE *_File) {
    return ftell(_File);
  }
  static inline __attribute__((__cdecl__)) _off64_t ftello64(FILE *_File) {
...
# 690 "C:/mingw64/x86_64-w64-mingw32/include/stdio.h" 3
  ...
  int __attribute__((__cdecl__)) _scprintf(const char * __restrict__ _Format,...)
  {
    ...
    __ret = __stdio_common_vsprintf(0x0002ULL, 0LL, 0, _Format, 0LL, __ap);
  ...
  int __attribute__((__cdecl__)) _snscanf(const char * __restrict__ _Src,size_t _MaxCount,const char * __restrict__ _Format,...)
  {
    ...
    int __ret;
    __builtin_va_start(__ap, _Format);
    __ret = __stdio_common_vsscanf(0, _Src, _MaxCount, _Format, 0LL, __ap);
    __builtin_va_end(__ap);
    return __ret;
  }
...
# 1212 "C:/mingw64/x86_64-w64-mingw32/include/stdio.h" 3
  ...
  static inline __attribute__((__cdecl__))
  int __attribute__((__cdecl__)) fwprintf(FILE * __restrict__ _File,const wchar_t * __restrict__ _Format,...)
  {
    __builtin_va_list __ap;
    int __ret;
    __builtin_va_start(__ap, _Format);
    __ret = __stdio_common_vfwprintf(0x0004ULL, _File, _Format, 0LL, __ap);
    __builtin_va_end(__ap);
    return __ret;
  }
  inline __attribute__((__cdecl__))
